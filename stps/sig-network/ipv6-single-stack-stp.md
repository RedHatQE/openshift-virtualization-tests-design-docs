...
| **API Extensions**               | [N/A] | No new IPv6 related APIs                                                                         |              |
...
| Compatibility Testing          | Ensures feature works across supported platforms, versions, and configurations                                                                               | Y                       | All existing component shold work on IPv6 single-stack clusters |
...
| Monitoring                     | Does the feature require metrics and/or alerts?                                                                                                              | Y                       | IPv6 metric is required                                         |
| Cloud Testing                  | Does the feature require multi-cloud platform testing? Consider cloud-specific features.                                                                     | N/A                     | Not required according to stakholders                           |
...
|:---------------------|:--------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------|:--------------|
| Timeline/Schedule    | Adjustments are required for many tests and it would take time to merge them                                        | Splitting to small tasks and get an exception for merging more necessary adjustments | [in-progress] |
| Test Coverage        | Cloud deployments require special configuration which is not available at the moment                                | Focus on bare-metal coverage which represents primary customer deployment scenario   | [x]           |
...
- Many tests adjustments are required. Finishing all adjustments could take time since not all tested components support IPv6: Flat overlay network, UDN and localnet.
...
|:-----------------|:------------------------------------------------------------|:------------------------|:-------|:---------|
| CNV-28924 (epic) | All existing components (Except the following limitations): | All existing scenarios  | Tier 2 | P0       |
|                  | - Flat overlay                                              |                         |        |          |
|                  | - Localnet                                                  |                         |        |          |
|                  | - C/UDN                                                     |                         |        |          |
