...
| **API Extensions**               | [x]  | New MigrationPolicy fields to control disruptive migration behavior and a VMI status field to report the migration mode used. |          |
| **Topology Considerations**      | [x]  | Requires at least 2 worker nodes for migration. Windows VMs require nodes with special infrastructure and high-resource capacity.                                |          |
