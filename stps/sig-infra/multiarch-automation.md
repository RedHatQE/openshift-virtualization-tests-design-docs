...
| **Testability**                        | [x]  | Requirements are testable through cluster configuration changes and resource observation.                                                                                                                                                                                            |          |
...
- VMs automatically select the correct architecture-specific DataSource based on node placement
...
| **Required Operators**                        | SSP, CDI, HCO                        |  |
...
- [ ] All P0, P1 test scenarios executed and passing (TC-01, TC-03, TC-06, TC-07, TC-11)
...
| TC-14          | Cross-architecture VM cloning                 | Clone amd64 VM, verify clone uses amd64 DataSource. Attempt cross-arch clone, verify appropriate error                         | Tier 2 | P1       |              |
...
- [ ] Tier 2 tests defined and automated (TC-02, TC-05, TC-08, TC-09, TC-10, TC-12, TC-13, TC-14)
